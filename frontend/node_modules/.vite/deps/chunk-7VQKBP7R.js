...
var loadRouteMatch = async (inner, matchPromises, index) => {
  ...
  if (shouldSkipLoader(inner, matchId)) {
    ...
    const previousRouteMatchId = ((_a = inner.router.state.matches[index]) == null ? void 0 : _a.routeId) === routeId ? inner.router.state.matches[index].id : (_b = inner.router.state.matches.find((d) => d.routeId === routeId)) == null ? void 0 : _b.id;
    const preload = resolvePreload(inner, matchId);
...
//# sourceMappingURL=chunk-7VQKBP7R.js.map
