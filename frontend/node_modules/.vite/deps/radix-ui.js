...
var require_use_sync_external_store_shim_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    (function() {
      ...
      var React67 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is, useState35 = React67.useState, useEffect40 = React67.useEffect, useLayoutEffect6 = React67.useLayoutEffect, useDebugValue = React67.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
...
var DialogPortal = (props) => {
  ...
  return (0, import_jsx_runtime13.jsx)(PortalProvider, { scope: __scopeDialog, forceMount, children: React32.Children.map(children, (child) => (0, import_jsx_runtime13.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime13.jsx)(Portal, { asChild: true, container, children: child }) })) });
};
...
var AlertDialogTrigger = React33.forwardRef(
  (props, forwardedRef) => {
...
var AlertDialogOverlay = React33.forwardRef(
  (props, forwardedRef) => {
...
var AlertDialogContent = React33.forwardRef(
  (props, forwardedRef) => {
    const { __scopeAlertDialog, children, ...contentProps } = props;
    const dialogScope = useDialogScope(__scopeAlertDialog);
    const contentRef = React33.useRef(null);
    const composedRefs = useComposedRefs(forwardedRef, contentRef);
    const cancelRef = React33.useRef(null);
...
var AlertDialogTitle = React33.forwardRef(
  (props, forwardedRef) => {
...
var AlertDialogAction = React33.forwardRef(
  (props, forwardedRef) => {
...
var AlertDialogCancel = React33.forwardRef(
  (props, forwardedRef) => {
...
var AspectRatio = React34.forwardRef(
  (props, forwardedRef) => {
...
var Avatar = React35.forwardRef(
  (props, forwardedRef) => {
    ...
    const [imageLoadingStatus, setImageLoadingStatus] = React35.useState("idle");
...
var AvatarImage = React35.forwardRef(
  (props, forwardedRef) => {
...
var AvatarFallback = React35.forwardRef(
  (props, forwardedRef) => {
    const { __scopeAvatar, delayMs, ...fallbackProps } = props;
    const context = useAvatarContext(FALLBACK_NAME, __scopeAvatar);
    const [canRender, setCanRender] = React35.useState(delayMs === void 0);
    React35.useEffect(() => {
      if (delayMs !== void 0) {
...
function useImageLoadingStatus(src, { referrerPolicy, crossOrigin }) {
  ...
  const imageRef = React35.useRef(null);
  const image = (() => {
  ...
  const [loadingStatus, setLoadingStatus] = React35.useState(
...
function usePrevious(value) {
  const ref = React36.useRef({ value, previous: value });
...
var PopperArrow = React41.forwardRef(function PopperArrow2(props, forwardedRef) {
...
var RovingFocusGroup = React42.forwardRef(
  (props, forwardedRef) => {
...
var RovingFocusGroupImpl = React42.forwardRef((props, forwardedRef) => {
  const {
  ...
  const [isTabbingBackOut, setIsTabbingBackOut] = React42.useState(false);
  const handleEntryFocus = useCallbackRef(onEntryFocus);
  const getItems = useCollection2(__scopeRovingFocusGroup);
  const isClickFocusRef = React42.useRef(false);
  const [focusableItemsCount, setFocusableItemsCount] = React42.useState(0);
  React42.useEffect(() => {
    const node = ref.current;
    if (node) {
  ...
  return (0, import_jsx_runtime20.jsx)(
    RovingFocusProvider,
    {
      ...
      loop,
      currentTabStopId,
      onItemFocus: React42.useCallback(
        (tabStopId) => setCurrentTabStopId(tabStopId),
        [setCurrentTabStopId]
      ),
      onItemShiftTab: React42.useCallback(() => setIsTabbingBackOut(true), []),
      onFocusableItemAdd: React42.useCallback(
        () => setFocusableItemsCount((prevCount) => prevCount + 1),
        []
      ),
      onFocusableItemRemove: React42.useCallback(
        () => setFocusableItemsCount((prevCount) => prevCount - 1),
        []
      ),
...
var RovingFocusGroupItem = React42.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeRovingFocusGroup,
      focusable = true,
...
var ContextMenu = (props) => {
  ...
  const handleOpenChange = React44.useCallback(
    (open2) => {
      setOpen(open2);
...
var ContextMenuTrigger = React44.forwardRef(
  (props, forwardedRef) => {
    const { __scopeContextMenu, disabled = false, ...triggerProps } = props;
    const context = useContextMenuContext(TRIGGER_NAME6, __scopeContextMenu);
    const menuScope = useMenuScope(__scopeContextMenu);
    const pointRef = React44.useRef({ x: 0, y: 0 });
    const virtualRef = React44.useRef({
      getBoundingClientRect: () => DOMRect.fromRect({ width: 0, height: 0, ...pointRef.current })
    });
    const longPressTimerRef = React44.useRef(0);
    const clearLongPress = React44.useCallback(
    ...
    React44.useEffect(() => clearLongPress, [clearLongPress]);
    React44.useEffect(() => void (disabled && clearLongPress()), [disabled, clearLongPress]);
...
var ContextMenuContent = React44.forwardRef(
  (props, forwardedRef) => {
...
var ContextMenuGroup = React44.forwardRef(
  (props, forwardedRef) => {
...
var ContextMenuLabel = React44.forwardRef(
  (props, forwardedRef) => {
...
var ContextMenuItem = React44.forwardRef(
  (props, forwardedRef) => {
...
var ContextMenuCheckboxItem = React44.forwardRef((props, forwardedRef) => {
...
var ContextMenuRadioGroup = React44.forwardRef((props, forwardedRef) => {
...
var ContextMenuRadioItem = React44.forwardRef((props, forwardedRef) => {
...
var ContextMenuItemIndicator = React44.forwardRef((props, forwardedRef) => {
...
var ContextMenuSeparator = React44.forwardRef((props, forwardedRef) => {
...
var ContextMenuArrow = React44.forwardRef(
  (props, forwardedRef) => {
...
var ContextMenuSubTrigger = React44.forwardRef((props, forwardedRef) => {
...
var ContextMenuSubContent = React44.forwardRef((props, forwardedRef) => {
...
var NAME5 = "Label";
var Label3 = React46.forwardRef((props, forwardedRef) => {
...
var Form = React47.forwardRef(
  (props, forwardedRef) => {
    ...
    const [validityMap, setValidityMap] = React47.useState({});
    const getFieldValidity = React47.useCallback(
      (fieldName) => validityMap[fieldName],
      [validityMap]
    );
    const handleFieldValidityChange = React47.useCallback(
    ...
    const handleFieldValiditionClear = React47.useCallback((fieldName) => {
      setValidityMap((prevValidityMap) => ({ ...prevValidityMap, [fieldName]: void 0 }));
      setCustomErrorsMap((prevCustomErrorsMap) => ({ ...prevCustomErrorsMap, [fieldName]: {} }));
    }, []);
    const [customMatcherEntriesMap, setCustomMatcherEntriesMap] = React47.useState({});
    const getFieldCustomMatcherEntries = React47.useCallback(
      (fieldName) => customMatcherEntriesMap[fieldName] ?? [],
      [customMatcherEntriesMap]
    );
    const handleFieldCustomMatcherAdd = React47.useCallback((fieldName, matcherEntry) => {
      setCustomMatcherEntriesMap((prevCustomMatcherEntriesMap) => ({
        ...prevCustomMatcherEntriesMap,
        [fieldName]: [...prevCustomMatcherEntriesMap[fieldName] ?? [], matcherEntry]
      }));
    }, []);
    const handleFieldCustomMatcherRemove = React47.useCallback((fieldName, matcherEntryId) => {
      setCustomMatcherEntriesMap((prevCustomMatcherEntriesMap) => ({
        ...prevCustomMatcherEntriesMap,
    ...
    const [customErrorsMap, setCustomErrorsMap] = React47.useState({});
    const getFieldCustomErrors = React47.useCallback(
      (fieldName) => customErrorsMap[fieldName] ?? {},
      [customErrorsMap]
    );
    const handleFieldCustomErrorsChange = React47.useCallback((fieldName, customErrors) => {
      setCustomErrorsMap((prevCustomErrorsMap) => ({
        ...prevCustomErrorsMap,
        [fieldName]: { ...prevCustomErrorsMap[fieldName] ?? {}, ...customErrors }
      }));
    }, []);
    const [messageIdsMap, setMessageIdsMap] = React47.useState({});
    const handleFieldMessageIdAdd = React47.useCallback((fieldName, id) => {
      setMessageIdsMap((prevMessageIdsMap) => {
        const fieldDescriptionIds = new Set(prevMessageIdsMap[fieldName]).add(id);
        return { ...prevMessageIdsMap, [fieldName]: fieldDescriptionIds };
      });
    }, []);
    const handleFieldMessageIdRemove = React47.useCallback((fieldName, id) => {
      setMessageIdsMap((prevMessageIdsMap) => {
    ...
    const getFieldDescription = React47.useCallback(
...
var FormField = React47.forwardRef(
  (props, forwardedRef) => {
...
var FormControl = React47.forwardRef(
  (props, forwardedRef) => {
    ...
    const updateControlValidity = React47.useCallback(
      async (control) => {
    ...
    const resetControlValidity = React47.useCallback(() => {
      const control = ref.current;
      if (control) {
...
var FormBuiltInMessage = React47.forwardRef(
  (props, forwardedRef) => {
...
var FormCustomMessage = React47.forwardRef(
  (props, forwardedRef) => {
    ...
    const _id = useId();
    const id = idProp ?? _id;
    const customMatcherEntry = React47.useMemo(() => ({ id, match }), [id, match]);
...
var FormMessageImpl = React47.forwardRef(
  (props, forwardedRef) => {
...
var FormSubmit = React47.forwardRef(
  (props, forwardedRef) => {
...
var Menubar = React49.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeMenubar,
      value: valueProp,
    ...
    return (0, import_jsx_runtime27.jsx)(
      MenubarContextProvider,
      {
        ...
        value,
        onMenuOpen: React49.useCallback(
          (value2) => {
            setValue(value2);
        ...
        onMenuToggle: React49.useCallback(
          (value2) => {
...
var MenubarTrigger = React49.forwardRef(
  (props, forwardedRef) => {
...
var MenubarGroup = React49.forwardRef(
  (props, forwardedRef) => {
...
var MenubarLabel = React49.forwardRef(
  (props, forwardedRef) => {
...
var MenubarItem = React49.forwardRef(
  (props, forwardedRef) => {
...
var MenubarCheckboxItem = React49.forwardRef(
  (props, forwardedRef) => {
...
var MenubarRadioGroup = React49.forwardRef(
  (props, forwardedRef) => {
...
var MenubarRadioItem = React49.forwardRef(
  (props, forwardedRef) => {
...
var MenubarSeparator = React49.forwardRef(
  (props, forwardedRef) => {
...
var MenubarArrow = React49.forwardRef(
  (props, forwardedRef) => {
...
var MenubarSubTrigger = React49.forwardRef(
  (props, forwardedRef) => {
...
var MenubarSubContent = React49.forwardRef(
  (props, forwardedRef) => {
...
var NavigationMenu = React50.forwardRef(
  (props, forwardedRef) => {
    const {
...
var NavigationMenuSub = React50.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeNavigationMenu,
      value: valueProp,
...
var NavigationMenuList = React50.forwardRef(
  (props, forwardedRef) => {
...
var NavigationMenuItem = React50.forwardRef(
  (props, forwardedRef) => {
...
var NavigationMenuLink = React50.forwardRef(
  (props, forwardedRef) => {
...
var NavigationMenuIndicatorImpl = React50.forwardRef((props, forwardedRef) => {
  ...
  const [activeTrigger, setActiveTrigger] = React50.useState(
    null
  );
...
var FocusGroup = React50.forwardRef(
  (props, forwardedRef) => {
...
var FocusGroupItem = React50.forwardRef(
  (props, forwardedRef) => {
    const { __scopeNavigationMenu, ...groupProps } = props;
...
var OneTimePasswordField = React51.forwardRef(
  function OneTimePasswordFieldImpl({
    ...
    const sanitizeValue = React51.useCallback(
      (value2) => {
...
var PasswordToggleField = ({
  ...
  const [inputIdState, setInputIdState] = React52.useState(defaultInputId);
  const inputId = inputIdState ?? defaultInputId;
  const syncInputId = React52.useCallback(
  ...
  const focusState = React52.useRef(INITIAL_FOCUS_STATE);
...
var PasswordToggleFieldInput = React52.forwardRef(
  ({
    __scopePasswordToggleField,
...
var PasswordToggleFieldToggle = React52.forwardRef(
  ({
    __scopePasswordToggleField,
    onClick,
    onPointerDown,
    ...
    const [internalAriaLabel, setInternalAriaLabel] = React52.useState(void 0);
...
var PasswordToggleFieldIcon = React52.forwardRef(
  ({
    __scopePasswordToggleField,
    // @ts-expect-error
    children,
...
var PopoverContentModal = React53.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime31.jsx)(Combination_default, { as: Slot3, allowPinchZoom: true, children: (0, import_jsx_runtime31.jsx)(
      PopoverContentImpl,
      {
        ...props,
        ref: composedRefs,
...
var Progress = React54.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeProgress,
...
var ProgressIndicator = React54.forwardRef(
  (props, forwardedRef) => {
...
var Radio = React55.forwardRef(
  (props, forwardedRef) => {
    ...
    const [button, setButton] = React55.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node) => setButton(node));
    const hasConsumerStoppedPropagationRef = React55.useRef(false);
...
var RadioIndicator = React55.forwardRef(
  (props, forwardedRef) => {
...
var RadioBubbleInput = React55.forwardRef(
  ({
    __scopeRadio,
    control,
    checked,
...
var Select = (props) => {
  ...
  const [valueNode, setValueNode] = React57.useState(null);
  const [valueNodeHasChildren, setValueNodeHasChildren] = React57.useState(false);
  const direction = useDirection(dir);
  const [open, setOpen] = useControllableState({
    prop: openProp,
    defaultProp: defaultOpen ?? false,
  ...
  const triggerPointerDownPosRef = React57.useRef(null);
  const isFormControl2 = trigger ? form || !!trigger.closest("form") : true;
  const [nativeOptionsSet, setNativeOptionsSet] = React57.useState(/* @__PURE__ */ new Set());
      ...
      children: [
        (0, import_jsx_runtime36.jsx)(Collection7.Provider, { scope: __scopeSelect, children: (0, import_jsx_runtime36.jsx)(
          SelectNativeOptionsProvider,
          {
            ...
            onNativeOptionAdd: React57.useCallback((option) => {
              setNativeOptionsSet((prev) => new Set(prev).add(option));
            }, []),
            onNativeOptionRemove: React57.useCallback((option) => {
...
var SelectTrigger = React57.forwardRef(
  (props, forwardedRef) => {
    ...
    const pointerTypeRef = React57.useRef("touch");
...
var SelectValue = React57.forwardRef(
  (props, forwardedRef) => {
...
var SelectIcon = React57.forwardRef(
  (props, forwardedRef) => {
...
var SelectContent = React57.forwardRef(
  (props, forwardedRef) => {
    const context = useSelectContext(CONTENT_NAME13, props.__scopeSelect);
    const [fragment, setFragment] = React57.useState();
    useLayoutEffect2(() => {
...
var SelectContentImpl = React57.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeSelect,
    ...
    const composedRefs = useComposedRefs(forwardedRef, (node) => setContent(node));
    const [selectedItem, setSelectedItem] = React57.useState(null);
    const [selectedItemText, setSelectedItemText] = React57.useState(
      null
    );
    const getItems = useCollection7(__scopeSelect);
    const [isPositioned, setIsPositioned] = React57.useState(false);
    const firstValidItemFoundRef = React57.useRef(false);
    React57.useEffect(() => {
      if (content) return hideOthers(content);
    }, [content]);
    useFocusGuards();
    const focusFirst6 = React57.useCallback(
      (candidates) => {
    ...
    const focusSelectedItem = React57.useCallback(
    ...
    const itemRefCallback = React57.useCallback(
      (node, value, disabled) => {
    ...
    const handleItemLeave = React57.useCallback(() => content == null ? void 0 : content.focus(), [content]);
    const itemTextRefCallback = React57.useCallback(
      (node, value, disabled) => {
        const isFirstValidItem = !firstValidItemFoundRef.current && !disabled;
        const isSelectedItem = context.value !== void 0 && context.value === value;
        if (isSelectedItem || isFirstValidItem) {
    ...
    return (0, import_jsx_runtime36.jsx)(
      SelectContentProvider,
      {
        ...
        isPositioned,
        searchRef,
        children: (0, import_jsx_runtime36.jsx)(Combination_default, { as: Slot4, allowPinchZoom: true, children: (0, import_jsx_runtime36.jsx)(
          FocusScope,
          {
            asChild: true,
...
var SelectItemAlignedPosition = React57.forwardRef((props, forwardedRef) => {
  const { __scopeSelect, onPlaced, ...popperProps } = props;
  const context = useSelectContext(CONTENT_NAME13, __scopeSelect);
  const contentContext = useSelectContentContext(CONTENT_NAME13, __scopeSelect);
  const [contentWrapper, setContentWrapper] = React57.useState(null);
  const [content, setContent] = React57.useState(null);
  const composedRefs = useComposedRefs(forwardedRef, (node) => setContent(node));
  const getItems = useCollection7(__scopeSelect);
  const shouldExpandOnScrollRef = React57.useRef(false);
  const shouldRepositionRef = React57.useRef(true);
  const { viewport, selectedItem, selectedItemText, focusSelectedItem } = contentContext;
  const position = React57.useCallback(() => {
  ...
  const handleScrollButtonChange = React57.useCallback(
    (node) => {
...
var SelectPopperPosition = React57.forwardRef((props, forwardedRef) => {
  const {
    __scopeSelect,
    align = "start",
...
var SelectViewport = React57.forwardRef(
  (props, forwardedRef) => {
    ...
    const prevScrollTopRef = React57.useRef(0);
...
var SelectGroup = React57.forwardRef(
  (props, forwardedRef) => {
...
var SelectLabel = React57.forwardRef(
  (props, forwardedRef) => {
...
var SelectItem = React57.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeSelect,
      value,
    ...
    const [textValue, setTextValue] = React57.useState(textValueProp ?? "");
    ...
    return (0, import_jsx_runtime36.jsx)(
      SelectItemContextProvider,
      {
        ...
        textId,
        isSelected,
        onItemTextChange: React57.useCallback((node) => {
...
var SelectItemText = React57.forwardRef(
  (props, forwardedRef) => {
    ...
    const [itemTextNode, setItemTextNode] = React57.useState(null);
    const composedRefs = useComposedRefs(
      forwardedRef,
    ...
    const nativeOption = React57.useMemo(
...
var SelectItemIndicator = React57.forwardRef(
  (props, forwardedRef) => {
...
var SelectScrollUpButton = React57.forwardRef((props, forwardedRef) => {
  const contentContext = useSelectContentContext(SCROLL_UP_BUTTON_NAME, props.__scopeSelect);
  const viewportContext = useSelectViewportContext(SCROLL_UP_BUTTON_NAME, props.__scopeSelect);
  const [canScrollUp, setCanScrollUp] = React57.useState(false);
...
var SelectScrollDownButton = React57.forwardRef((props, forwardedRef) => {
  const contentContext = useSelectContentContext(SCROLL_DOWN_BUTTON_NAME, props.__scopeSelect);
  const viewportContext = useSelectViewportContext(SCROLL_DOWN_BUTTON_NAME, props.__scopeSelect);
  const [canScrollDown, setCanScrollDown] = React57.useState(false);
  const composedRefs = useComposedRefs(forwardedRef, viewportContext.onScrollButtonChange);
  useLayoutEffect2(() => {
    if (contentContext.viewport && contentContext.isPositioned) {
      let handleScroll22 = function() {
...
var SelectScrollButtonImpl = React57.forwardRef((props, forwardedRef) => {
  const { __scopeSelect, onAutoScroll, ...scrollIndicatorProps } = props;
  const contentContext = useSelectContentContext("SelectScrollButton", __scopeSelect);
  const autoScrollTimerRef = React57.useRef(null);
  const getItems = useCollection7(__scopeSelect);
  const clearAutoScrollTimer = React57.useCallback(() => {
...
var SelectSeparator = React57.forwardRef(
  (props, forwardedRef) => {
...
var SelectArrow = React57.forwardRef(
  (props, forwardedRef) => {
...
var SelectBubbleInput = React57.forwardRef(
...
function useTypeaheadSearch(onSearchChange) {
  ...
  const handleTypeaheadSearch = React57.useCallback(
    (key) => {
      const search = searchRef.current + key;
  ...
  const resetTypeahead = React57.useCallback(() => {
    searchRef.current = "";
    window.clearTimeout(timerRef.current);
  }, []);
  React57.useEffect(() => {
...
var Separator4 = React58.forwardRef((props, forwardedRef) => {
...
var Slider = React59.forwardRef(
  (props, forwardedRef) => {
    ...
    const thumbRefs = React59.useRef(/* @__PURE__ */ new Set());
    const valueIndexToChangeRef = React59.useRef(0);
    ...
    const valuesBeforeSlideStartRef = React59.useRef(values);
...
var SliderHorizontal = React59.forwardRef(
  (props, forwardedRef) => {
    const {
      min: min2,
      max: max2,
    ...
    const [slider, setSlider] = React59.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node) => setSlider(node));
    const rectRef = React59.useRef(void 0);
    const direction = useDirection(dir);
    const isDirectionLTR = direction === "ltr";
...
var SliderVertical = React59.forwardRef(
  (props, forwardedRef) => {
    const {
      min: min2,
      max: max2,
...
var SliderImpl = React59.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeSlider,
      onSlideStart,
...
var SliderTrack = React59.forwardRef(
  (props, forwardedRef) => {
...
var SliderRange = React59.forwardRef(
  (props, forwardedRef) => {
...
var SliderThumb = React59.forwardRef(
  (props, forwardedRef) => {
    const getItems = useCollection8(props.__scopeSlider);
    const [thumb, setThumb] = React59.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node) => setThumb(node));
    const index2 = React59.useMemo(
...
var SliderThumbImpl = React59.forwardRef(
  (props, forwardedRef) => {
...
var SliderBubbleInput = React59.forwardRef(
...
var Switch = React60.forwardRef(
  (props, forwardedRef) => {
    ...
    const [button, setButton] = React60.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node) => setButton(node));
    const hasConsumerStoppedPropagationRef = React60.useRef(false);
    const isFormControl2 = button ? form || !!button.closest("form") : true;
    const [checked, setChecked] = useControllableState({
      prop: checkedProp,
      defaultProp: defaultChecked ?? false,
...
var SwitchThumb = React60.forwardRef(
  (props, forwardedRef) => {
...
var SwitchBubbleInput = React60.forwardRef(
  ({
    __scopeSwitch,
    control,
    checked,
...
var ToastProvider = (props) => {
  ...
  const [toastCount, setToastCount] = React62.useState(0);
  const isFocusedToastEscapeKeyDownRef = React62.useRef(false);
  const isClosePausedRef = React62.useRef(false);
  if (!label.trim()) {
    console.error(
  ...
  return (0, import_jsx_runtime41.jsx)(Collection9.Provider, { scope: __scopeToast, children: (0, import_jsx_runtime41.jsx)(
    ToastProviderProvider,
    {
      ...
      viewport,
      onViewportChange: setViewport,
      onToastAdd: React62.useCallback(() => setToastCount((prevCount) => prevCount + 1), []),
      onToastRemove: React62.useCallback(() => setToastCount((prevCount) => prevCount - 1), []),
...
var ToastViewport = React62.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeToast,
    ...
    const headFocusProxyRef = React62.useRef(null);
    const tailFocusProxyRef = React62.useRef(null);
    ...
    const getSortedTabbableCandidates = React62.useCallback(
      ({ tabbingDirection }) => {
...
var FocusProxy = React62.forwardRef(
  (props, forwardedRef) => {
...
var ToastImpl = React62.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeToast,
      type = "foreground",
    ...
    const [node, setNode] = React62.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node2) => setNode(node2));
    const pointerStartRef = React62.useRef(null);
    const swipeDeltaRef = React62.useRef(null);
    const duration = durationProp || context.duration;
    const closeTimerStartTimeRef = React62.useRef(0);
    const closeTimerRemainingTimeRef = React62.useRef(duration);
    const closeTimerRef = React62.useRef(0);
    ...
    const startTimer = React62.useCallback(
      (duration2) => {
    ...
    const announceTextContent = React62.useMemo(() => {
...
var ToastAnnounce = (props) => {
  ...
  const context = useToastProviderContext(TOAST_NAME, __scopeToast);
  const [renderAnnounceText, setRenderAnnounceText] = React62.useState(false);
  const [isAnnounced, setIsAnnounced] = React62.useState(false);
...
var ToastTitle = React62.forwardRef(
  (props, forwardedRef) => {
...
var ToastDescription = React62.forwardRef(
  (props, forwardedRef) => {
...
var ToastAction = React62.forwardRef(
  (props, forwardedRef) => {
...
var ToastClose = React62.forwardRef(
  (props, forwardedRef) => {
...
var ToastAnnounceExclude = React62.forwardRef((props, forwardedRef) => {
...
var NAME7 = "Toggle";
var Toggle = React63.forwardRef((props, forwardedRef) => {
...
var TooltipProvider = (props) => {
  ...
  const isOpenDelayedRef = React66.useRef(true);
  const isPointerInTransitRef = React66.useRef(false);
  ...
  return (0, import_jsx_runtime45.jsx)(
    TooltipProviderContextProvider,
    {
      ...
      isOpenDelayedRef,
      delayDuration,
      onOpen: React66.useCallback(() => {
        window.clearTimeout(skipDelayTimerRef.current);
        isOpenDelayedRef.current = false;
      }, []),
      onClose: React66.useCallback(() => {
        window.clearTimeout(skipDelayTimerRef.current);
        skipDelayTimerRef.current = window.setTimeout(
      ...
      onPointerInTransitChange: React66.useCallback((inTransit) => {
...
var Tooltip = (props) => {
  ...
  const wasOpenDelayedRef = React66.useRef(false);
  const [open, setOpen] = useControllableState({
    prop: openProp,
    defaultProp: defaultOpen ?? false,
    onChange: (open2) => {
  ...
  const stateAttribute = React66.useMemo(() => {
  ...
  return (0, import_jsx_runtime45.jsx)(Root25, { ...popperScope, children: (0, import_jsx_runtime45.jsx)(
    TooltipContextProvider,
    {
      ...
      trigger,
      onTriggerChange: setTrigger,
      onTriggerEnter: React66.useCallback(() => {
        if (providerContext.isOpenDelayedRef.current) handleDelayedOpen();
        else handleOpen();
      }, [providerContext.isOpenDelayedRef, handleDelayedOpen, handleOpen]),
      onTriggerLeave: React66.useCallback(() => {
...
var TooltipTrigger = React66.forwardRef(
  (props, forwardedRef) => {
    ...
    const isPointerDownRef = React66.useRef(false);
    const hasPointerMoveOpenedRef = React66.useRef(false);
    const handlePointerUp = React66.useCallback(() => isPointerDownRef.current = false, []);
    React66.useEffect(() => {
...
var TooltipContent = React66.forwardRef(
  (props, forwardedRef) => {
...
var TooltipContentHoverable = React66.forwardRef((props, forwardedRef) => {
  const context = useTooltipContext(CONTENT_NAME15, props.__scopeTooltip);
  const providerContext = useTooltipProviderContext(CONTENT_NAME15, props.__scopeTooltip);
  const ref = React66.useRef(null);
  const composedRefs = useComposedRefs(forwardedRef, ref);
  const [pointerGraceArea, setPointerGraceArea] = React66.useState(null);
  const { trigger, onClose } = context;
  const content = ref.current;
  const { onPointerInTransitChange } = providerContext;
  const handleRemoveGraceArea = React66.useCallback(() => {
    setPointerGraceArea(null);
    onPointerInTransitChange(false);
  }, [onPointerInTransitChange]);
  const handleCreateGraceArea = React66.useCallback(
    (event, hoverTarget) => {
...
var TooltipContentImpl = React66.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeTooltip,
      children,
...
var TooltipArrow = React66.forwardRef(
  (props, forwardedRef) => {
