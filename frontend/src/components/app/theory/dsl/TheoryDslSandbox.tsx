    ...
    <Card className="py-4">
      ...
      <CardContent className="space-y-3 px-4">
        ...
        <div className="flex w-full justify-center">
          <div className="flex w-full max-w-[19rem] flex-col items-stretch gap-2">
            <RouteBackButton fallbackTo="/maze" className="w-full" />
            <Badge
              variant="outline"
              className="w-full max-w-full justify-center whitespace-normal px-2.5 py-1.5 text-center text-[11px] leading-4 tracking-tight text-slate-700 min-[375px]:whitespace-nowrap"
            >
