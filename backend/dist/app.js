...
app.use("/mazePaths", mazePathRoutes_1.mazePathRouter);
app.use("/mazePaths", findPathRoutes_1.findPathRouter);
app.use("/mazes", mazeRoutes_1.mazeRouter);
app.use("/sessions", sessionCreateRoutes_1.sessionRouter);
